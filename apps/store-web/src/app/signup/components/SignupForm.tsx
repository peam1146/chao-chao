...
import signup from '@/assets/images/Saly-1.png'
  ...
  return (
    <div className="h-fit w-fit flex items-center flex-col md:flex-row md:pl-10 my-auto">
      <div className="h-[295px] w-[238px] md:hidden">
        <Image src={signup} width={0} height={0} sizes="100vw" alt="Signup Picture" />
      </div>

      <div className="h-fit w-fit flex flex-col items-center gap-4 md:gap-12 my-auto">
        ...
        <div className="w-full flex flex-col gap-y-5">
          ...
          <div className="w-full relative">
            ...
            <Input type="tel" placeholder="Phone number" className="pl-9" />
          </div>
          <div className="w-full relative">
            <div className="absolute h-full flex items-center justify-center ml-3">
        ...
        <div className="flex flex-col items-center gap-y-2">
          <Button className="bg-primary w-[100%] md:w-[108px]">Sign up</Button>
